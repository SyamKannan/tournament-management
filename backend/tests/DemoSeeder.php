...
/**
 * Test-only fixture: loads the demonstration dataset: three organizations on different plans,
 ...
 *
 * The fixture in `Fixtures/demo.json` was captured at a fixed instant. Every date it
...
class DemoSeeder extends Seeder
{
    ...
    {
        $path = __DIR__.'/Fixtures/demo.json';
