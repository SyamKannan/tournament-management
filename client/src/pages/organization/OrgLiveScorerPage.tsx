...
export const OrgLiveScorerPage: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      {/* CRICKET LIVE SCORER INTERFACE — locked until the toss is recorded,
          matching the backend's 422 on /cricket/ball without a toss_decision. */}
      {!isFootball && !match.toss_decision && (
        <div className="p-6 rounded-3xl glass-panel border border-slate-800 text-center text-sm text-slate-400">
          Complete the coin toss above to unlock ball-by-ball scoring.
        </div>
      )}
      {!isFootball && match.toss_decision && (
